...
- <img height="16" src="logos/docker.svg" alt="Docker"> <img height="16" src="logos/apple.svg" alt="Apple"> Container-based filesystem and network isolation
- <img height="16" src="logos/cloudflare.svg" alt="Cloudflare"> Secure Cloudflare tunnels with TLS
- <img height="16" src="logos/oauth.svg" alt="OAuth"> OAuth2.1 with PKCE is used to authenticate with the AI provider
