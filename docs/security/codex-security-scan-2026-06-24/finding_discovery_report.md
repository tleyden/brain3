...
1. `brain3-host-header-metadata`
   ...
   - Evidence: [crates/platform/src/http/oauth_handlers.rs](../../../crates/platform/src/http/oauth_handlers.rs) `resolve_base_url` at lines 289-299 and `oauth_metadata` at 647-666; [crates/platform/src/http/mcp_handlers.rs](../../../crates/platform/src/http/mcp_handlers.rs) `resolve_base_url` at 17-27 and `proxy_error_response` at 137-145.
...
2. `brain3-unallowlisted-redirect-uri`
   ...
   - Evidence: [crates/platform/src/http/oauth_handlers.rs](../../../crates/platform/src/http/oauth_handlers.rs) `validate_authorize_params` at 347-374 only checks non-empty `redirect_uri`; [crates/platform/src/http/registrar.rs](../../../crates/platform/src/http/registrar.rs) `bound_redirect` at 32-45 round-trips the caller-supplied URI unchanged.
...
3. `brain3-quick-tunnel-default-public-ingress`
   ...
   - Evidence: [crates/core/src/application/first_run_setup.rs](../../../crates/core/src/application/first_run_setup.rs) sets `TunnelModeDraft::CloudflareQuick` by default at 30-40; [crates/platform/src/config/env_file.rs](../../../crates/platform/src/config/env_file.rs) defaults `B3_CF_QUICK_TUNNEL` to `true` at 428-437; [.env.template](../../../.env.template) documents `B3_CF_QUICK_TUNNEL=true` at 47-50.
...
4. `brain3-sensitive-mcp-trace-logs`
   ...
   - Evidence: [crates/core/src/application/proxy_mcp.rs](../../../crates/core/src/application/proxy_mcp.rs) logs request/response bodies at 104-106 and 132-134; [brain3-mcp-vault-tools/src/brain3_mcp_vault_tools/server.py](../../../brain3-mcp-vault-tools/src/brain3_mcp_vault_tools/server.py) logs full MCP bodies at 240-250 and 256-270; [crates/platform/src/setup/system.rs](../../../crates/platform/src/setup/system.rs) creates temp log files at 242-263 without a later permission hardening step.
