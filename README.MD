...
- Uses <img height="16" src="docs/logos/docker.svg" alt="Docker"> Docker and <img height="16" src="docs/logos/apple.svg" alt="Apple"> Native MacOS container technology to reduce the attack surface
