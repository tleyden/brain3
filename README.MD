...
Windows release artifacts are published for the `x86_64-pc-windows-msvc` target. First-run cloudflared auto-install is not implemented on Windows yet.
